...
public class ShooterCommands {
  ...
  public static final ShooterSetpoint[] SETPOINTS =
      Arrays.stream(
              new ShooterSetpoint[] {
                new ShooterSetpoint(
                    Meters.of(2.94), Rotations.of(0), RotationsPerSecond.of(39), Seconds.of(0.82)),
                new ShooterSetpoint(
                    Meters.of(3.42), Rotations.of(0), RotationsPerSecond.of(41), Seconds.of(0.93)),
                new ShooterSetpoint(
                    Meters.of(4), Rotations.of(0), RotationsPerSecond.of(43.25), Seconds.of(0.95)),
                new ShooterSetpoint(
                    Meters.of(4.5), Rotations.of(0), RotationsPerSecond.of(46), Seconds.of(1.09)),
                new ShooterSetpoint(
                    Meters.of(5.04), Rotations.of(0), RotationsPerSecond.of(49.5), Seconds.of(1.1)),
                new ShooterSetpoint(
                    Meters.of(5.5), Rotations.of(0), RotationsPerSecond.of(62), Seconds.of(1.11)),
                new ShooterSetpoint(
                    Meters.of(6), Rotations.of(0), RotationsPerSecond.of(65), Seconds.of(1.37))
              })
          .sorted()
