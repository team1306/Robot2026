...
public final class Constants {
  ...
  public static class Locations {
    ...
    public static final Translation2d leftCornerBlueLocation = new Translation2d(1, 6);
    public static final Translation2d rightCornerBlueLocation = new Translation2d(1, 1.2);
