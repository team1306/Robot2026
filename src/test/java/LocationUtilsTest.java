...
public class LocationUtilsTest {
  @Test
  void testGetDistanceToPosition() {
    // testing linear
  ...
  @Test
  void testGetDirectionToPosition() {
    // Testing 0
    Translation2d p1 = new Translation2d(0, 0);
    Translation2d p2 = new Translation2d(1, 0);
    Rotation2d angle = LocationUtils.getDirectionToLocation(p1, p2);
    assertEquals(0, angle.getDegrees(), 1e-9);

    // Testing 45
    p2 = new Translation2d(1, 1);
    angle = LocationUtils.getDirectionToLocation(p1, p2);
    assertEquals(45, angle.getDegrees(), 1e-9);

    // Testing non-zero start
    p1 = new Translation2d(1, 0);
    p2 = new Translation2d(2, 1);
    angle = LocationUtils.getDirectionToLocation(p1, p2);
    assertEquals(45, angle.getDegrees(), 1e-9);
  }
}
